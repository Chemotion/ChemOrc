...
func getComposeAddressToUse(currentVersion, action string) (use string) {
	...
	versions[latestForThisCLIRelease] = "https://raw.githubusercontent.com/Chemotion/ChemOrc/88cf662a6314a8583d04b9f7594c1478fa5f042e/payload/docker-compose.yml"
